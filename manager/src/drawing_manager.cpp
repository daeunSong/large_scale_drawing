...
//    dm.visualizeStrokes(drawing.strokes, drawing.color);
  ...
  dm.visualizeStrokes(dm.drawings[0].strokes_by_range[0], 'b');
//  dm.visualizeStrokes(dm.drawings[1].strokes_by_range[0], 'b');
//  dm.visualizeStrokes(dm.drawings[2].strokes_by_range[0], 'b');
...
//  dm.visualizeStrokes(dm.drawings[2].strokes_by_range[1], 'o');
  ...
  dm.visualizeStrokes(dm.drawings[0].strokes_by_range[2], 'g');
//  dm.visualizeStrokes(dm.drawings[1].strokes_by_range[2], 'g');
//  dm.visualizeStrokes(dm.drawings[2].strokes_by_range[2], 'g');
